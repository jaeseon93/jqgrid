...
public class JsonUtil {
	...
	/**
	 * FuncName : JsonToLinkedHashMap() FuncDesc : Json String -> LinkedHashMap 형태
	 * 변환(들어온 순서대로) Param : param : Json String Return : Map<String, Object>
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * FuncName : ListToJson() FuncDesc : List -> Json String 변환 Param : res : Json
	...
	/**
	 * FuncName : OneStringToJson() FuncDesc : Json String 변환 Param : sData : String
	 * Return : String
	 */
	...
	/**
	 * FuncName : HashMapToJson() FuncDesc : Json String 변환 Param : sData : String
	 * Return : String
	 */
